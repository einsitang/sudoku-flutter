...
class Nativefl {
  ...
  late final ffi.Pointer<ffi.Pointer<ffi.Char>> _VERSION =
      _lookup<ffi.Pointer<ffi.Char>>('VERSION');

  ffi.Pointer<ffi.Char> get VERSION => _VERSION.value;

  set VERSION(ffi.Pointer<ffi.Char> value) => _VERSION.value = value;
  ...
  late final _GeneratePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int, ffi.Pointer<ffi.Void>)>>('Generate');
  late final _Generate =
      _GeneratePtr.asFunction<void Function(int, ffi.Pointer<ffi.Void>)>();
  ...
  late final _SolvePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<ffi.Void>, ffi.Int, ffi.Pointer<ffi.Void>)>>('Solve');
...
final class sudoku_channel extends ffi.Struct {
  @ffi.Int()
  external int err;

  external ffi.Pointer<ffi.SignedChar> matrix;
}
...
const String LIBSUDOKU_VERSION = '0.0.0';
